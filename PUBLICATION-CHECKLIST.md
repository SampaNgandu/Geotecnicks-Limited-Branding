...
- [ ] Confirm the availability and agreed role of specialist support.
- [ ] Review all references to ASTM/ISRM methods and Zambian requirements with an appropriately qualified reviewer; ensure wording does not imply accreditation or blanket certification.
- [ ] Verify every service capability and remove anything not currently deliverable.
